...
```
POST http://192.168.0.191:8888/api/payer/claimconnect/service-provided/{contractUuid}
...
external.api.external-api-base-url=http://192.168.0.191:8888
...
**Example Request:**
```bash
POST http://192.168.0.191:8888/api/payer/claimconnect/service-provided/contract-123-uuid
Content-Type: application/json
X-API-Key: your-api-key
